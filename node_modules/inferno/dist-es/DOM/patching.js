import { combineFrom, isArray, isFunction, isInvalid, isNull, isNullOrUndef, isNumber, isObject, isString, isStringOrNumber, isUndefined, NO_OP, throwError } from 'inferno-shared';
import options from '../core/options';
import { createTextVNode, createVoidVNode, directClone, isVNode } from '../core/VNodes';
...
import { appendChild, EMPTY_OBJ, insertOrAppend, isKeyed, removeAllChildren, replaceChild, replaceLastChildAndUnmount, replaceVNode, replaceWithNewNode, setTextContent, updateTextContent } from './utils';
    ...
    if (lastTag !== nextTag) {
        ...
        if (lastProps !== nextProps) {
            ...
            if (nextPropsOrEmpty !== EMPTY_OBJ) {
                let isFormElement = (nextFlags & 3584 /* FormElement */) > 0;
                if (isFormElement) {
